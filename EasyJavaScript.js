...
var library = {
	...
	functionsArray: ['copy()', 'random()', 'clock()', 'docId()', 'docTag()', 'docClass()', 'blockById()', 'noneById()', 'blockByTag()', 'noneByTag()', 'blockByClass()', 'noneByClass()', 'randomColor()', 'time()', 'colorById()', 'colorByTag()', 'colorByClass()', 'bgColorById()', 'bgColorByTag()', 'bgColorByClass()', 'fontById()', 'fontByClass()', 'fontByTag'],
	resum: function() {
